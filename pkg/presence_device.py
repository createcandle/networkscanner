...
class PresenceDevice(Device):
    ...
    def __init__(self, adapter, _id, name, details):
        ...
        if details == None:
            print("ERROR, presence device init: provided details was None")
        else:
            if isinstance(details, str):
                print("OLD FASHIONED: provided details is a string (so only an ip address): ", details)
                ...
                if 'ip' in details:
                    self.properties['ip'] = PresenceProperty(
                        self,
                        'ip',
                        {
                            'title': 'IP address',
                ...
                if 'mac' in details:
                    self.properties['mac'] = PresenceProperty(
                        self,
                        'mac',
                        {
                            'title': 'Mac address',
                ...
                if 'hostname' in details:
                    self.properties['hostname'] = PresenceProperty(
                        self,
                        'hostname',
                        {
                            'title': 'Host name',
                ...
                if 'data_collection' in details:
                    self.properties['data_collection'] = PresenceProperty(
                        self,
                        'data_collection',
                        {
